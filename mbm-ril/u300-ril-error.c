...
const char *errorCauseToString(int cause)
{
    ...
    switch (cause) {
        case E2NAP_CAUSE_SUCCESS:
            string = "E2NAP_CAUSE_SUCCESS";
            break;
        case E2NAP_CAUSE_GPRS_ATTACH_NOT_POSSIBLE:
            string = "E2NAP_CAUSE_GPRS_ATTACH_NOT_POSSIBLE";
            break;
        case E2NAP_CAUSE_NO_SIGNAL_CONN:
            string = "E2NAP_CAUSE_NO_SIGNAL_CONN";
            break;
        case E2NAP_CAUSE_REACTIVATION_POSSIBLE:
            string = "E2NAP_CAUSE_REACTIVATION_POSSIBLE";
            break;
        case E2NAP_CAUSE_ACCESS_CLASS_BARRED:
            string = "E2NAP_CAUSE_ACCESS_CLASS_BARRED";
            break;
        case GPRS_OP_DETERMINED_BARRING:
            string = "GPRS_OP_DETERMINED_BARRING";
            break;
...
const char *e2napStateToString(int state)
{
    ...
    switch (state) {
        case E2NAP_STATE_DISCONNECTED:
            string = "E2NAP_STATE_DISCONNECTED";
            break;
        case E2NAP_STATE_CONNECTED:
            string = "E2NAP_STATE_CONNECTED";
            break;
        case E2NAP_STATE_CONNECTING:
            string = "E2NAP_STATE_CONNECTING";
            break;
        default:
